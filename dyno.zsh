...
function dyno() {
    ...
    case $1 in
        ...
        "update")
            echo -e "${Green}Current version: $version$ColorOff"
            echo -e "${Green}Downloading ...$ColorOff"
        ...
        "--uninstall")
            ...
            if [[ "$decision" == "Y" ]]; then
                ...
                if [[ "$answer" == "y" ]]; then
                    ...
                    echo -e "${Green}Creating export file...$ColorOff"
        ...
        *)  # Default case
            ...
            echo -e "${Red}For more information, use 'dyno help' or 'dyno --help'.$ColorOff"
        ;;
    esac
}
